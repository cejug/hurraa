...
import org.cejug.hurraa.validation.impl.EquipmentTypeNameAvailableValidator;


@Target({ ElementType.PARAMETER , ElementType.FIELD })
@Retention(RetentionPolicy.RUNTIME)
@Constraint( validatedBy = { EquipmentTypeNameAvailableValidator.class })
@ReportAsSingleViolation
@Documented
public @interface EquipmentTypeNameAvailable {
